...
@section('container')
    <main class="content">
        <div class="container-fluid p-0">
            ...
            <h1 class="h3 mb-3"><strong>Tambah Data Rak</strong></h1>

            <div class="row">
                <div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
                    <div class="card flex-fill w-100 p-3">
                        <h5 class="card-title mb-3">TAMBAH DATA RAK</h5>
                        <form action="/dashboard/data-rak" method="post" enctype="multipart/form-data">
                        @csrf
                          ...
                          <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                              <input type="text" class="form-control @error('namaRak')
                                  is-invalid
                              @enderror mb-3" id="namaRak" name="namaRak" placeholder="Masukkan Nama Rak" value="{{ old('namaRak') }}" required>
                              @error('namaRak')
