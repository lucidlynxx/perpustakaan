                    ...
                    <table class="table table-hover my-0" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if ($current->format('Y-m-d') > $peminjaman->tglKembali && $peminjaman->status ==
                                'pinjam')
                                ...
                                @if ($current->format('Y-m-d') > $peminjaman->tglKembali && $peminjaman->status ==
                                'pinjam')
                                <td>Rp{{ number_format($peminjaman->tglKembali->diffInDays() * 2000, 0, ',', '.');
                                    }}</td>
                                @else
                                ...
                                <td>
                                    ...
                                    <div class="btn-group-sm d-grid gap-1">
                                        <a href="/dashboard/data-peminjaman/{{ $peminjaman->slug }}"
                                            class="btn btn-primary">Menyerahkan</a>
                                        <a href="/dashboard/data-peminjaman/{{ $peminjaman->slug }}/perpanjang"
